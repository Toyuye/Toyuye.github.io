  ...
  getDesignPage({ dispatch }: { dispatch: Dispatch }, payload: any) {
    return new Promise((resolve, reject) => {
      ...
      dispatch("updateComponentList", [
        { name: "文本", id: 1, moduleSign: "ImgModule", moduleJson: "{}" },
        { name: "文本", id: 2, moduleSign: "VideoModule", moduleJson: "{}" },
        { name: "文本", id: 3, moduleSign: "VideoModule", moduleJson: "{}" },
        { name: "文本", id: 4, moduleSign: "ImgModule", moduleJson: "{}"  },
        { name: "文本", id: 5, moduleSign: "ImgModule", moduleJson: "{}"  },
        { name: "文本", id: 6, moduleSign: "ImgModule", moduleJson: "{}"  },
        { name: "文本", id: 7, moduleSign: "ImgModule", moduleJson: "{}"  },
        { name: "文本", id: 8, moduleSign: "ImgModule", moduleJson: "{}"  },
        { name: "文本", id: 9, moduleSign: "ImgModule", moduleJson: "{}"  },
        { name: "文本", id: 10, moduleSign: "ImgModule", moduleJson: "{}"  },
        { name: "文本", id: 11, moduleSign: "ImgModule", moduleJson: "{}"  },
        { name: "文本", id: 12, moduleSign: "ImgModule", moduleJson: "{}"  },
        { name: "文本", id: 13, moduleSign: "ImgModule", moduleJson: "{}"  },
        { name: "文本", id: 14, moduleSign: "ImgModule", moduleJson: "{}"  },
        { name: "文本", id: 15, moduleSign: "ImgModule", moduleJson: "{}"  },
        { name: "文本", id: 16, moduleSign: "ImgModule", moduleJson: "{}"  },
        { name: "文本", id: 17, moduleSign: "ImgModule", moduleJson: "{}"  },
        { name: "文本", id: 18, moduleSign: "ImgModule", moduleJson: "{}"  },
        { name: "文本", id: 19, moduleSign: "ImgModule", moduleJson: "{}"  },
